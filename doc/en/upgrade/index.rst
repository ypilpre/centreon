...
**Use packages** if you installed using Centreon ISO or RPM, and sources files
if you installed from sources. Before upgrading Centreon, please don't forget to
	make a backup.
